...
LEXICON_RU: dict[str, str] = {
    "start": "Приветствую! Я бот - напоминалка,"
    " могу сохранять ваши сообщения на указанные вами даты и время.\n"
    "Для более подробной справки отправьте команду /help.\n"
    "Для начала работы отправьте мне любое сообщение.",
    "help": "Я бот - напоминалка. Отправьте мне сообщение,"
    " и если формат сообщения позволит его сохранить в базе"
    " данных, я попрошу вас указать сначала дату"
    " в формате ДД ММ ГГГГ, а после - время в формате ЧЧ ММ. После,"
    " когда наступит указанное вами дата и время,"
    " я перешлю ваше сообщение.\n"
    "Вам доступны следующие команды:\n"
    "/reminds - я попрошу вас ввести дату в формате ДД.ММ.ГГГГ,"
    " и после выведу список всех ваших"
    ...
    "Любой список заметок, как и сами заметки,"
    " можно в любой момент отредактировать.\n"
    "/premium - у обычного пользователя есть пара ограничений."
    " Он может сохранить не более 50 заметок,"
    " и только в виде текста. Если же вы хотите снять всякие"
    " ограничения и закинуть моему автору на чай,"
    " отправьте мне эту команду;)"
    "Теперь, если хотите сохранить заметку, просто отправьте ее мне.",
    "date_msg": "Введите дату, когда вам отправить напоминание,"
    " в формате ДД.ММ.ГГГГ (если отправите в формате ДД ММ,"
    ...
    "wrong_format_date_msg": "Вы ввели несуществующую дату"
    " или дату в неправильном формате.\n"
    ...
    " Пожалуйста, отправьте мне дату в правильном формате "
    "(ДД.ММ.ГГГГ или ДД.ММ или ДД) или"
    " отмените сохранение заметки, нажав на кнопку ОТМЕНА",
    "time_msg": "Введите время в формате ЧЧ:ММ",
    "past_time": "Выбранное вами время уже прошло."
    " Пожалуйста, выберете время, которое еще не прошло.",
    ...
    "reminders": "Пожалуйста, введите дату, "
    "заметки на которую вы хотите просмотреть, в формате ДД.ММ.ГГГГ",
    "previous_page": "<<",
    ...
    "exceeding_limit_on_reminders": "Вы не можете добавить новую заметку,"
    " так как количество напоминаний"
    ...
    "not_text_from_not_premium": "Пользователи без премиум-статуса могут "
    "сохранять только текстовые напоминания.",
    "can_not_change_text": "Сохраненное напоминание является"
    " либо голосовым сообщением либо видео-заметкой."
    " У таких сообщений нет подписей и их нельзя изменить.",
}
