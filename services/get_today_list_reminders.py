...
def plan_cron_save_today_reminders(scheduler: AsyncIOScheduler,
    ...
    scheduler.add_job(_save_list_today_reminders, trigger='cron',
...
def plan_date_save_today_reminders(scheduler: AsyncIOScheduler,
                                   pool: Pool,
                                   today_reminders: TodayRemindersClass):
    scheduler.add_job(_save_list_today_reminders, trigger='date',
...
async def _save_list_today_reminders(pool: Pool,
                                     today_reminders: TodayRemindersClass):
